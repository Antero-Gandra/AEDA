...
public:
	...
	* @param id an unsigined integer, name a string, address a string, mobile an unsigined int, dob a Calendar Object, specialiy a string
	*/
	...
	* @return unsigined integer Person's mobile
	*/
