...
Contestant::Contestant(unsigned int id, string name, string address, unsigned int mobile, Calendar dob, string specialty, std::vector<Participation*> participation): Person(name, address, mobile, dob, specialty) {
	this->id = id;
	this->participations = participations;
}
//Set Methods
